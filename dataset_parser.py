...
def train_test_split_DataLoader(batch_size = 256, subject_list = [i+1 for i in range(40)], exercise_list=[1,2,3], fs=2000, \
    ...
    valid_loader = DataLoader(dataset=dataset_valid, batch_size=batch_size, shuffle=False, num_workers=12)
    test_loader = DataLoader(dataset=dataset_test, batch_size=batch_size, shuffle=False, num_workers=12)
